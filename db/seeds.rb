...
#  if User.count == 0
#    User.create :name => "Béky Miklós", :email_address => "miklos.beky@gmail.com", :password => "mitminek", :password_confirmation => "mitminek", :editor => false, :administrator => true, :state => "active"
#  end
