...
ActiveRecord::Schema.define(:version => 20101121184325) do
  ...
  add_index "interpersonal_relations", ["related_person_id"], :name => "index_interpersonal_relations_on_related_person_id"
  ...
  add_index "p2o_relation_types", ["p2p_relation_type_id"], :name => "index_p2o_relation_types_on_p2p_relation_type_id"
  ...
  add_index "p2p_relation_types", ["pair_id"], :name => "index_p2p_relation_types_on_pair_id"
